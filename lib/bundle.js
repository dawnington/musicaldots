...
/***/ function(module, exports, __webpack_require__) {
	...
	const Circle = __webpack_require__(7);
	const Dot = __webpack_require__(6);
	const dotOptions = __webpack_require__(9);
	const keyBindings = __webpack_require__(10);
	...
	const Explosions = (function (canvas, ctx) {
	  ...
	  document.addEventListener('keydown', function (e) {
	    ...
	    if (Object.keys(keyBindings).indexOf(keyCode) > -1) {
	      const key = keyBindings[e.keyCode];
